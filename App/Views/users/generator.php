...
<div class="container">
    <div class="row">
        ...
        <p>Click sur le boutton pour générer le formulaire.</p>
    ...
    <input type="file" name="fileUpload" id="fileUpload">
        ...
        <div class="col-12 col-md-6">
            <div class="container template">
                <div class="row justify-contend-left" id="content">
                ...
                <div class="col-12 col-md-7 form2">
                    ...
                    <div class="form-group">
                     ...
                     <div class="row">
                     <p id="setapropos" class="ma">bienvenue elit. Facere esse, quibusdam vel laudantium laboriosam placeat deserunt beatae excepturi neque optio! Nihil voluptates magnam repudiandae molestiae commodi veniam culpa architecto quod.</p>
                     </div>
                    </div>
                ...
                <input type="button" id="telecharger" value="telecharger"></input>
                    </div>
                </div>
        </div>
...
//creation de l'input pour l'envoie de la photo
    var mg = document.createElement('div');
var photo = document.createElement("input");
photo.type = "file";
photo.id="fileUpload";
photo.className="form-control";
photo.style.width="425px";
photo.style.marginBottom="12px" 
mg.appendChild(photo);


photo.addEventListener('click', function() {       
const uploadedImageDiv=document.getElementById("uploadedImage");
const mg=document.getElementById("fileUpload");
 mg.addEventListener("change", getImage, false);
 let cropper = null;
...
//Refer.style.border="1px solid blue";
    ...
    // const inputone=document.querySelector('#fileUpload');
    // const ouputone=document.querySelector('#uploadedImage');
    // inputone.addEventListener('input',(event)=>{
    //    const one =event.target.value;
    //     document.querySelector('#uploadedImage').textContent=one;
    // });
...
<script>
//   const inputone=document.querySelector('#fileUpload');
//     const ouputone=document.querySelector('#setphoto');
//     inputone.addEventListener('input',(event)=>{
//        const one =event.target.value;
//         document.querySelector('#setphoto').textContent=one;
//     });

</script>
<script>

     //pour télecharger le cv
(function () {  
            var  
